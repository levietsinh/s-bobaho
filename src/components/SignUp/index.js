  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      phoneNumber: Yup.string()
        ...
        .matches(/^((\\+[1-9]{1,4}[ \\-]*)|(\\([0-9]{2,3}\\)[ \\-]*)|([0-9]{2,4})[ \\-]*)*?[0-9]{3,4}?[ \\-]*[0-9]{3,4}?$/, 'Số điện thoại di động không hợp lệ'),
      password: Yup.string()
  ...
  return (
    <EntranceLayout>
      ...
      <div className={styles.form}>
        {submittedForm ? <div className={styles.submittedText}>Đăng ký thành công</div> : 
