  ...
  return(
    <div>
      ...
      <div className={styles.home}>
        <img src={BackgroundWave} className={styles.home__background}/>
        <img src={TheEarthImg} className={styles.home__earthImg}/>
        <div className={styles.home__heading}>
          ...
          <p className={styles.home__headingP}>
            <img src={GrownImg} alt="Grown" className={ styles.home__headingGrown }/>
      ...
      <div className={styles.welcome}>
        ...
        <div className={styles.welcome__subtext}>
          ...
          <p>Với mức lãi suất hấp dẫn, khách hàng có thể tự tin về việc sợ tiền lãi quá cao </p>
        </div>
        <div>
          <Button
            variant="contained"
